    ...
    <a href="{{ route('keuangan.pdf', request()->query()) }}" target="_blank">
        <button class="px-2 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition flex items-center gap-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2m-6 0h6v4H6v-4h6z" />
            </svg>
        </button>
    </a>
...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-7 mb-4">
    <div class="bg-lightblue-100 rounded-2xl p-6 sm:mb-4">
    ...
    <div class="bg-lightpurple-100 rounded-2xl p-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-1">
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.54512 10.3922L2 12L3.3802 6.3939L5.10201 8.0468L7.87931 5.1537C7.97359 5.05548 8.10385 5 8.24 5C8.37615 5 8.50641 5.05548 8.60069 5.1537L10.64 7.27801L13.6393 4.1537C13.8305 3.95447 14.1471 3.94807 14.3463 4.13931C14.5455 4.33054 14.5519 4.64706 14.3607 4.8463L11.0007 8.34627C10.9064 8.44448 10.7762 8.5 10.64 8.5C10.5038 8.5 10.3736 8.44448 10.2793 8.34627L8.24 6.22199L5.82341 8.73933L7.54512 10.3922Z" fill="#E53E3E"></path>
                </svg>
            </div>
        </div>
    </div>
...
<div class="p-2 bg-lightwhite dark:bg-white/5 rounded-lg flex gap-2 justify-between mb-2 ">
    <div class="flex items-center gap-4">
        <div class="flex gap-2 items-center">
            ...
            <div x-data="{ open: false }">
                <button type="button" @click="open = !open" class="flex items-center gap-x-2 px-3 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
                        ...
                        <div x-show="open" x-transition x-transition.duration.300 class="bg-white dark:bg-black relative shadow-3xl border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8" style="display: none;">
                            ...
                            <div class="p-5">
                                <div x-data="{ tab: 'pengeluaran' }">
                                    <div class="flex mb-4">
                                        <button :class="tab === 'pengeluaran' ? 'bg-purple-600 text-white' :
                                                    'bg-gray-100 text-black'" class="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-l-lg focus:outline-none transition-all duration-200 w-full" @click="tab = 'pengeluaran'">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                                            </svg>
                                            Pengeluaran
                                        </button>
                                        <button :class="tab === 'pemasukan' ? 'bg-blue-600 text-white' :
                                                    'bg-gray-100 text-black'" class="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-r-lg focus:outline-none transition-all duration-200 w-full" @click="tab = 'pemasukan'">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <form action="{{ route('keuangan.add') }}" method="POST" enctype="multipart/form-data" class="space-y-4" id="myForm">
                                            ...
                                            <div class="mb-4 relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 flex items-center gap-4">
                                                ...
                                                <div style="width: 70%;">
                                                    ...
                                                    <input type="text" name="tanggal" id="tanggal" class="form-input w-full">
                                                </div>
    ...
    <div>
        <div class="flex items-center gap-2 mt-2">
            <input type="text" id="produkTableSearch" placeholder="Cari transaksi di tabel..." class="w-full form-input !rounded-full py-2.5 px-4 text-black dark:text-white border border-black/10 dark:border-white/10 placeholder:text-black/20 dark:placeholder:text-white/20 focus:border-black dark:focus:border-white focus:ring-0 focus:shadow-none" autocomplete="off">
            <a href="{{ route('keuangan.kalender') }}" id="calendarFilterBtn" class="p-2 rounded-full bg-gray-100 hover:bg-blue-100 dark:bg-black border border-gray-200 flex items-center justify-center" title="Lihat Kalender">
...
<div class="border bg-lightwhite dark:bg-white/5 dark:border-white/10 border-black/10 p-2 rounded-md mb-5">
    ...
    <div class="flex flex-col md:flex-row justify-between mb-2 gap-2">
        <div x-data="{ openFilter: false }" class="relative">
            <button type="button" @click="openFilter = !openFilter" class="p-2 rounded-lg bg-gray-100 hover:bg-blue-100 dark:bg-black border border-gray-200 flex items-center gap-1">
                <i class="fas fa-filter"></i>
                <span class=" md:inline">Filter</span>
            </button>
            <div x-show="openFilter" @click.away="openFilter = false" class="absolute z-50 mt-2 left-0 bg-white dark:bg-black border border-gray-200 dark:border-white/10 rounded-lg shadow-lg p-4 min-w-[320px]">
                        ...
                        <div class="flex flex-col">
                            <span class="font-semibold leading-tight">
                                <a href="#" @click.prevent="openDetail = true" class="hover:underline">
                                    ...
                                    <div x-show="openDetail" x-transition class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60" style="display: none; z-index:9999;">
                                        <div class="bg-white dark:bg-black rounded-lg shadow-lg w-full max-w-lg relative" @click.away="openDetail = false">
                                            ...
                                            <div class="flex justify-between items-center border-b px-5 py-3">
                                                ...
                                                <div class="flex gap-2">
                                                    ...
                                                    <a href="" class="px-3 py-1 rounded bg-red-600 text-white hover:bg-red-700 focus:outline-none transition inline-block" onclick="event.preventDefault(); Swal.fire({
                                                ...
                                                <form action="{{ route('keuangan.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                                    ...
                                                    <div class="mb-4 relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 flex items-center gap-4">
                                                        ...
                                                        <div x-data="{ fileName: '', fileUrl: '' }">
                                                            <label for="foto-upload-edit-{{ $item->id }}" :class="fileName ? 'bg-green-100 border-green-500' :
                                                                                'bg-gray-100'" class="cursor-pointer flex flex-col items-center justify-center w-24 h-24 border-2 border-dashed rounded-lg hover:bg-gray-200 transition-colors duration-200">
                                                                ...
                                                                <input id="foto-upload-edit-{{ $item->id }}" type="file" name="foto" class="hidden" @change="
                                                    ...
                                                    <div class="mb-4 relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10">
                                                        <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Kategori
                                                            Transaksi</label>
                                                        <select name="id_akun" class="select-form kategori_edit_{{ $item->id }} w-full" style="width: 100%;" data-placeholder="Pilih Kategori Akun">
                                                            ...
                                                            <option value="{{ $akunItem->id }}" {{ $item->id_akun == $akunItem->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="mb-4 relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 flex items-center gap-4">
                                                        <div class="flex-1">
                                                            <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Jumlah
                                                                (Rp)</label>
                                                            <input type="text" name="total" class="form-input" placeholder="Jumlah" autocomplete="off" inputmode="numeric" id="total_edit_{{ $item->id }}" value="Rp. {{ number_format($item->total, 0, ',', '.') }}">
                                                        </div>
                                                        <script>
                                                            document.addEventListener('DOMContentLoaded', function() {
                                                        ...
                                                        <div x-data="{ openRekening: false, selectedRekening: '{{ $item->id_rekening }}', selectedRekeningName: '{{ $item->rekening->nama_rekening ?? '' }}' }" class="relative">
                                                            <button type="button" @click="openRekening = !openRekening" class="flex items-center gap-2 px-3 py-2 border rounded-lg bg-gray-100 dark:bg-black dark:border hover:bg-gray-200 transition">
                                                                ...
                                                                <span class="hidden sm:block" x-text="selectedRekeningName ? selectedRekeningName : '{{ $item->rekening->nama_rekening ?? 'Rekening' }}'">
                                                            ...
                                                            <div x-show="openRekening" @click.away="openRekening = false" class="fixed inset-0 z-[1001] flex items-center justify-center" style="background: rgba(0,0,0,0.2);">
                                                                <div class="bg-white dark:bg-black dark:border:border-black border border-gray-200 rounded-lg shadow-lg w-80 max-w-full" @click.stop>
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <button type="button" @click="selectedRekening = '{{ $rek->id }}'; selectedRekeningName = '{{ \Illuminate\Support\Str::limit($rek->nama_rekening, 10, '...') }}'; openRekening = false" class="w-full text-left px-4 py-2 hover:bg-blue-100 transition">
                                                                                <span class="block truncate max-w-[200px] flex items-center">
                                                                                    {{ $rek->nama_rekening }}
                                                    ...
                                                    <div class="flex gap-5">
                                                        <!-- Tombol Batal -->
                                                        <button @click.prevent="openDetail = false" type="button" class="w-full bg-red-100 text-red-600 px-4 py-2 rounded-lg hover:bg-red-200 focus:outline-none">
                                                            Batal
                                                        </button>
...
<script>
    $(document).ready(function() {
        ...
        $('.kategori_keluar, .kategori_masuk').select2({
            placeholder: 'Pilih Kategori Akun'
            , width: '100%'
