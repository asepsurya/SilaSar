...
@section('container')
    ...
    <div x-show="showSearch" x-transition class="mb-4 w-full">
        <input type="text" id="produkTableSearch" placeholder="Cari transaksi..."
    ...
    <div class="w3-content w3-display-container relative max-w-xl mx-auto mb-3 mobile_view">
        ...
        <div x-data="{ show: false }"
            class="bg-lightblue-100 rounded-2xl p-6 mySlides w-full h-[200px] flex flex-col justify-center">
            ...
            <div class="flex items-center gap-2">
                ...
                <button @click="show = !show" class="p-2 rounded-full bg-white hover:bg-gray-100 shadow">
                    <!-- Icon mata tertutup -->
                    <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-600" fill="none"
        ...
        <!-- Pengeluaran -->
        <div x-data="{ show: false }"
            class="bg-lightpurple-100 rounded-2xl p-6 mySlides w-full h-[200px] flex flex-col justify-center">
        ...
        <!-- Tombol panah -->
        <button class="absolute left-0 top-1/2 -translate-y-1/2  text-white text-3xl px-3 py-2 rounded-r-lg"
            onclick="plusDivs(-1)">&#10094;</button>
        <button class="absolute right-0 top-1/2 -translate-y-1/2  text-white text-3xl px-3 py-2 rounded-l-lg"
            onclick="plusDivs(1)">&#10095;</button>
    ...
    <div class="p-2  rounded-lg flex items-center gap-2 mb-2 hidden md:flex">
        ...
        <div class="flex-shrink-0">
            <button type="button" @click="$dispatch('transaksi')"
                ...
                <div x-show="open" x-transition x-transition.duration.300
                    ...
                    <div class="p-5">
                        ...
                        <form action="{{ route('keuangan.add') }}" method="POST" enctype="multipart/form-data"
                            class="space-y-4" id="formTransaksi">
                            @csrf
                            {{-- TANGGAL & WAKTU --}}
                            <div
                                class="mb-2 relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 flex items-center gap-4">
                                <div style="width:70%">
                            ...
                            <div class="mb-2  bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 ">
                                <div class="mb-2 ">
                                    ...
                                    <select name="jenis_transaksi" id="" class="jenis_transaksi select-form w-full"
                                        style="width:100%;" data-placeholder="Pilih Jenis Transaksi">
                                        <option></option>
                                        <option value="pemasukan" data-kategori="Menambah aset dari pendapatan">Pemasukan
                                        </option>
                                        <option value="pengeluaran" data-kategori="Mengurangi aset untuk biaya">Pengeluaran
                                        </option>
                                        <option value="hutang" data-kategori="Menerima dana hutang">Hutang</option>
                                        <option value="bayar_hutang" data-kategori="Melunasi kewajiban hutang">Bayar Hutang
                                        </option>
                                        <option value="piutang" data-kategori="Memberi pinjaman (piutang)">Piutang</option>
                                        <option value="terima_piutang" data-kategori="Menerima pembayaran piutang">Terima
                                            Piutang</option>
                                        <option value="tanam_modal" data-kategori="Setoran modal dari pemilik">Tanam Modal
                                        </option>
                                        <option value="tarik_modal" data-kategori="Pengambilan modal oleh pemilik">Tarik
                                            Modal</option>
                                        <option value="transfer" data-kategori="Mutasi antar rekening">Transfer Uang
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <textarea name="deskripsi" class="form-input" rows="2"
                            ...
                            <div class="mb-4 relative bg-white dark:bg-white/5 rounded-lg border border-black/10">
                                <div class="py-4 px-5">
                                    ...
                                    <select name="id_akun" id="" class="akun_debit select-form w-full" style="width:100%;"
                                        data-placeholder="Pilih Akun Debit"></select>
                                </div>
                                ...
                                <div class="py-2 px-5 mb-2">
                                    ...
                                    <select name="id_akun_second" id="" class="akun_kredit select-form w-full"
                                        style="width:100%;" data-placeholder="Pilih Akun Kredit"></select>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="total" class="currency form-input" placeholder="Rp(0)"
                                        autocomplete="off" inputmode="numeric" id="total_pengeluaran">
                                </div>

                                <!-- Kotak Rekening dengan Icon -->
                                <div x-data="{ openRekening: false, selectedRekening: '', selectedRekeningName: '' }"
                                    class="relative">
                                    <button type="button" @click="openRekening = !openRekening"
                                        ...
                                        <svg class="w-4 h-4 ml-1 text-gray-400" fill="none" stroke="currentColor"
                                            stroke-width="2" viewBox="0 0 24 24">
                                            <path d="M19 9l-7 7-7-7" stroke="currentColor" stroke-linecap="round"
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <span class="block truncate max-w-[200px] flex items-center">
                                                                    ...
                                                                    <template
                                                                        ...
                                                                        <svg class="w-4 h-4 text-green-500 ml-2" fill="none"
    ...
    <div class="clean-table-container mb-5">
        @php
        ...
        <div class="table-responsive">
            <table class="clean-table" id="produkTable">
                ...
                @foreach ($groupedTransaksi as $tanggal => $items)
                    ...
                    <thead>
                        ...
                        <tr class="text-gray-400 lg:hidden">
                            <th width="50%" class="text-left font-normal">
                                <div>Masuk: <span class="text-green-600">Rp {{ number_format($pemasukan, 0, ',', '.') }}</span>
                                </div>
                            </th>
                            <th class="text-left">
                                <div>Keluar: <span class="text-red-600">Rp {{ number_format($pengeluaran, 0, ',', '.') }}</span>
                                </div>
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr class="border rounded-lg p-3 bg-white dark:bg-black shadow-sm  dark:border-white/10"
                                x-data="{ openDetail: false }">
                                <!-- Produk / Transaksi -->
                                <td class="py-4 pl-6 flex items-start gap-3">
                                    <div class="flex flex-col"
                                        onclick="window.dispatchEvent(new CustomEvent('detail-{{ $item->id }}'))">
                                        <!-- Trigger Modal -->
                                                ...
                                                <form action="{{ route('keuangan.update') }}" method="POST"
                                                    ...
                                                    <div
                                                        ...
                                                        <div style="width:70%">
                                                            ...
                                                            <input type="text" name="tanggal" class=" form-input w-full"
                                                                value=" {{ $item->tanggal }}" readonly>
                                                        </div>
                                                        <div style="width:30%">
                                                            <label
                                                                class="block text-xs text-black/40 dark:text-white/40 mb-1">Waktu</label>
                                                            <input type="hidden"
                                                                class=" form-input w-full cursor-not-allowed waktu_display" disabled
                                                                value="{{ $item->waktu }}">
                                                            <input type="text" name="waktu"
                                                                class="form-input w-full cursor-not-allowed"
                                                                value="{{ $item->waktu ?? '-' }}" readonly>
                                                        </div>
                                                    </div>

                                                    {{-- JENIS TRANSAKSI --}}
                                                    <div
                                                        class="mb-2 bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10">
                                                        <div class="mb-2">
                                                            <label class="block text-xs text-black/40 dark:text-white/40 mb-1">
                                                                Jenis Transaksi <span style="color:red">*</span>
                                                            </label>
                                                            <select name="jenis_transaksi" id=""
                                                                class="jenis_transaksi select-form w-full" style="width:100%;"
                                                                data-placeholder="Pilih Jenis Transaksi">
                                                                <option></option>
                                                                <option value="pemasukan"
                                                                    data-kategori="Menambah aset dari pendapatan"
                                                                    @selected($item->jenis_transaksi == 'pemasukan')>Pemasukan
                                                                </option>
                                                                <option value="pengeluaran"
                                                                    data-kategori="Mengurangi aset untuk biaya"
                                                                    @selected($item->jenis_transaksi == 'pengeluaran')>Pengeluaran
                                                                </option>
                                                                <option value="hutang" data-kategori="Menerima dana hutang"
                                                                    @selected($item->jenis_transaksi == 'hutang')>Hutang</option>
                                                                <option value="bayar_hutang"
                                                                    data-kategori="Melunasi kewajiban hutang"
                                                                    @selected($item->jenis_transaksi == 'bayar_hutang')>Bayar Hutang
                                                                </option>
                                                                <option value="piutang" data-kategori="Memberi pinjaman (piutang)"
                                                                    @selected($item->jenis_transaksi == 'piutang')>Piutang</option>
                                                                <option value="terima_piutang"
                                                                    data-kategori="Menerima pembayaran piutang"
                                                                    @selected($item->jenis_transaksi == 'terima_piutang')>Terima
                                                                    Piutang</option>
                                                                <option value="tanam_modal"
                                                                    data-kategori="Setoran modal dari pemilik"
                                                                    @selected($item->jenis_transaksi == 'tanam_modal')>Tanam Modal
                                                                </option>
                                                                <option value="tarik_modal"
                                                                    data-kategori="Pengambilan modal oleh pemilik"
                                                                    @selected($item->jenis_transaksi == 'tarik_modal')>Tarik Modal
                                                                </option>
                                                                <option value="transfer" data-kategori="Mutasi antar rekening"
                                                                    @selected($item->jenis_transaksi == 'transfer')>Transfer Uang
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <input type="hidden" name="tipe" id="" value="{{ $item->tipe }}"
                                                            class="tipe">
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div x-data="{
                                                            ...
                                                            <label for="foto-upload-2-{{ $item->id }}"
                                                                ...
                                                                <!-- File name truncated -->
                                                                <span
                                                                    x-text="fileName2 ? fileName2.length > 10 ? fileName2.substring(0,10)+'...' : fileName2 : 'Upload Foto'"
                                                                    class="text-xs text-gray-500 mt-1 text-center block truncate max-w-full"></span>

                                                                <!-- File input -->
                                                                <input id="foto-upload-2-{{ $item->id }}" type="file" name="foto"
                                                                    class="hidden" @change="
                                                                                    fileName2 = $event.target.files[0]?.name || '';
                                                                                    if ($event.target.files[0]) {
                                                                                        const reader = new FileReader();
                                                                ...
                                                                <template x-if="fileUrl2">
                                                                    <button type="button"
                                                                        @click="fileName2=''; fileUrl2=''; $refs.inputFile.value='';"
                                                    ...
                                                    {{-- AKUN DEBIT & KREDIT --}}
                                                    <div
                                                        class="mb-4 relative bg-white dark:bg-white/5 rounded-lg border border-black/10">
                                                        <div class="py-4 px-5">
                                                            <label id=""
                                                                class="label_debit block text-xs text-black/40 dark:text-white/40 mb-1">
                                                                Debit <span style="color:red">*</span>
                                                            </label>
                                                            <select name="id_akun" id="" class="akun_debit select-form w-full"
                                                                style="width:100%;" data-placeholder="Pilih Akun Debit">
                                                                @foreach ($akun as $a)
                                                                    <option value="{{ $a->id }}"
                                                                        data-kategori="{{ $a->kategori->nama_kategori ?? '1' }}"
                                                                        @selected($item->id_akun == $a->id)>{{ $a->nama_akun }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="py-2 px-5 mb-2">
                                                            <label id=""
                                                                class="label_kredit block text-xs text-black/40 dark:text-white/40 mb-1">
                                                                Kredit <span style="color:red">*</span>
                                                            </label>
                                                            <select name="id_akun_second" id=""
                                                                class="akun_kredit select-form w-full" style="width:100%;"
                                                                data-placeholder="Pilih Akun Kredit">
                                                                @foreach ($akun as $a)
                                                                    <option value="{{ $a->id }}"
                                                                        data-kategori="{{ $a->kategori->nama_kategori ?? '1' }}"
                                                                        @selected($item->id_akun_second == $a->id)>{{ $a->nama_akun }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-1">
                                                            <label
                                                                class="block text-xs text-black/40 dark:text-white/40 mb-1">Nominal
                                                                <span style="color: red">*</span></label>
                                                            <input type="text" name="total" class="currency form-input"
                                                                placeholder="Rp(0)" autocomplete="off" inputmode="numeric"
                                                                value="Rp. {{ number_format($item->total, 0, ',', '.') }}">
                                                        </div>

                                                        <!-- PILIH REKENING -->
                                                        <div x-data="{ openRekening: false, selectedRekening: '{{ $item->id_rekening }}', selectedRekeningName: '{{ optional($rekening->firstWhere('id', $item->id_rekening))->nama_rekening }}' }"
                                                            class="relative">
                                                            <button type="button" @click="openRekening = !openRekening"
                                                                class="flex items-center gap-2 px-3 py-2 border rounded-lg bg-gray-100 dark:bg-black dark:border hover:bg-gray-200 transition">
                                                                <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor"
                                                                ...
                                                                <span x-text="selectedRekeningName || 'Pilih Rekening'"
                                                            ...
                                                            <div x-show="openRekening" @click.away="openRekening = false"
                                                                class="fixed inset-0 z-[1001] flex items-center justify-center"
                                                                style="background: rgba(0,0,0,0.2);">
                                                                <div class="bg-white dark:bg-black border border-gray-200 rounded-lg shadow-lg w-80 max-w-full"
                                                                    @click.stop>
                                                                    ...
                                                                    <ul>
                                                                        @foreach ($rekening as $r)
                                                                            <li>
                                                                                <button type="button"
                                                                                    @click="selectedRekening = '{{ $r->id }}'; selectedRekeningName = '{{ \Illuminate\Support\Str::limit($r->nama_rekening, 10, '...') }}'; openRekening = false"
                                                                                    class="w-full text-left px-4 py-2 hover:bg-blue-100 transition">
                                                                                    <span
                                                                                        class="block truncate max-w-[200px] flex items-center">
                                                                                        {{ $r->nama_rekening }}
                                                                                        <template
                                                                                            x-if="selectedRekening === '{{ $r->id }}'">
                                                    ...
                                                    <div class="">
                                                        <button type="submit"
                                                            class="mb-2 w-full bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center justify-center">
                                                            Update
                                                        </button>
                                                        <button type="button"
                                                            class="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center justify-center"
