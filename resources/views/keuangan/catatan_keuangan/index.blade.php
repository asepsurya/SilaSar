    ...
    <style>
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('keuangan.pdf.harian', request()->query()) }}" target="_blank">
                <button
                    class="px-2 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition flex items-center gap-2">
                    PDF
        ...
        <div class="p-2 rounded-lg flex gap-2 justify-between mb-2 ">
            <div class="flex items-center gap-4">
                <div class="flex gap-2 items-center">
                    <button type="button" @click="window.dispatchEvent(new CustomEvent('transaksi'))"
                        ...
                        <div x-show="open" x-transition x-transition.duration.300
                            ...
                            <div class="p-5">
                                ...
                                <div x-data="{ tab: 'pengeluaran' }">
                                    <div class="flex mb-4">
                                        <button :class="tab === 'pengeluaran' ? 'bg-red-600 text-white' :
                                    ...
                                    <div x-show="tab === 'pengeluaran'">
                                        <form action="{{ route('keuangan.add.harian') }}" method="POST"
                                            ...
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Tanggal
                                                        <span style="color: red">*</span></label>
                                                    <input type="text" name="tanggal" class="form-input" id="tanggal_keluar">
                                                    <!-- Pastikan flatpickr locale id sudah di-load -->
                                                    <script
                                                        src="https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/id.js"></script>
                                                    <script>
                                                    ...
                                                    <label for="foto-upload-2"
                                                        ...
                                                        <template x-if="!fileUrl2">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="w-8 h-8 text-gray-400" fill="none" viewBox="0 0 24 24"
                                                                stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                            ...
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <input type="text" name="total" class="form-input" placeholder="Jumlah"
                                            ...
                                            <div class="flex ">
                                                <button id="submitBtnPengeluaran" type="submit"
                                                ...
                                                <div x-data="{ fileName: '', fileUrl: '' }">
                                                    <label for="foto-upload"
                                                        ...
                                                        <span x-text="fileName ? fileName : 'Upload Foto'"
                                                            class="text-xs text-gray-500 mt-1 text-center"></span>
                                                        <input id="foto-upload" type="file" name="foto" class="hidden" @change="
                                            ...
                                            <div
                                                ...
                                                <div class="flex-1">
                                                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Jumlah
                                                        (Rp) <span style="color: red">*</span></label>
                                                    <input type="text" name="total" class="form-input" placeholder="Jumlah"
                                                        autocomplete="off" inputmode="numeric" id="total_pemasukan">
                                                </div>
                                                <script>
                                                    // Format input as currency (Rp. 2.000.000) but submit as plain number (2000000)
                                                    document.addEventListener('DOMContentLoaded', function () {
                                ...
                                <tr class="text-gray-400 lg:table-header-group">
                                    ...
                                    <th class="text-left">
                                        <div class="flex flex-col lg:flex-row gap-4 text-gray-600 hidden sm:block">
                                            <div>Masuk: <span class="text-green-600">Rp
                                                    {{ number_format($pemasukan, 0, ',', '.') }}</span></div>
                                            <div>Keluar: <span class="text-red-600">Rp
                                        ...
                                        <td class="py-4 pl-6 flex items-start gap-3">
                                            <div class="flex flex-col">
                                                <span class="font-semibold leading-tight">
                                                    <a href="#" @click="window.dispatchEvent(new CustomEvent('detail-{{ $item->id }}'))"
                                                    ...
                                                    <!-- Modal -->
                                                    <div x-data="{ open: false }" @detail-{{ $item->id }}.window="open = true"
                                                        ...
                                                        <div class="fixed inset-0 bg-black/60 dark:bg-white/10 z-[999] hidden overflow-y-auto"
                                                            ...
                                                            <div class="flex items-center justify-center min-h-screen px-4"
                                                                ...
                                                                <div x-show="open" x-transition x-transition.duration.300
                                                                    ...
                                                                    <!-- Isi modal (semua isi form/tab pengeluaran/pemasukan kamu) -->
                                                                    <div class="p-5">
                                                                        <form action="{{ route('keuangan.update.harian') }}"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="flex-1">
                                                                                    ...
                                                                                    <textarea name="deskripsi" class="form-input"
                                                                                        rows="2"
                                                                                        placeholder="Deskripsi Transaksi">{{ $item->deskripsi }}</textarea>
                                                                                </div>
                                                                                <div x-data="{ fileName: '', fileUrl: '' }">
                                                                                    <label for="foto-upload-edit-{{ $item->id }}"
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            class="text-xs text-gray-500 mt-1 text-center"></span>
                                                                                        <input id="foto-upload-edit-{{ $item->id }}"
                                                                                            type="file" name="foto" class="hidden"
                                                                                            @change="
                                                                                                    fileName = $event.target.files[0]?.name || '';
                                                                                                    if ($event.target.files[0]) {
                                                                                                        const reader = new FileReader();
                            ...
                            <tr>
                                <td colspan="10" class="py-16">
                                    <div class="flex flex-col items-center justify-center text-gray-400">
                                        <!-- Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-12 h-12 mb-3 text-gray-300 dark:text-gray-500" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
