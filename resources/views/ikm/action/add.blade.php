        ...
        <div class="grid grid-cols-1 2xl:grid-cols-2 gap-2">
            <div>
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">NIK <span
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Nama <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Tempat Lahir <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Tanggal Lahir <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Jenis Kelamin <span
                            style="color:red">*</span></label>
                ...
                <!-- Alamat -->
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Alamat <span
                            style="color:red">*</span></label>
                ...
                <div class="flex gap-3 mb-3">
                    <div class="flex-1 py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">RT <span
                                style="color:red">*</span></label>
                        <input type="text" name="rt" placeholder="RT" class="form-input"
                            value="{{ old('rt', $item->rt ?? '') }}" />
                    </div>
                    <div class="flex-1 py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">RW <span
                                style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Provinsi <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Kota / Kabupaten <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Kecamatan <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Desa <span
                            style="color:red">*</span></label>
            ...
            <div>
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Agama <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Status <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Pekerjaan <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 bg-white rounded-lg border border-black/10 relative dark:bg-white/5 mb-3">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Kewarganegaraan <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">No. Telepon <span
                            style="color:red">*</span></label>
                ...
                <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                    <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Email <span
                            style="color:red">*</span></label>
