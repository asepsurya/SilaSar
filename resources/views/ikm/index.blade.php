...
@section('container')
    ...
    <div x-data="{ tab: 'harian' }" class=" ">
        ...
        <div class="flex space-x-2 bg-gray-100 dark:bg-white/5 p-3 w-max m-5 ">
            <!-- Data Pengguna -->
            <button :class="tab === 'harian' ? 'bg-blue-600 text-white' : 'bg-white/5 text-gray-800'"
            ...
            <!-- Keaktifan Pengguna -->
            <a href="{{ route('keaktifan.pengguna') }}"
                class="flex items-center space-x-2 px-4 py-2 text-sm font-semibold rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                <!-- Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <div class="">
            <div x-show="tab === 'harian'" class="p-4 rounded-lg ">
                ...
                <div x-data="dataPengguna" x-init="init()"
