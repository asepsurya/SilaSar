...
@section('container')
    ...
    <div class="px-2 py-1 mb-2 flex items-center justify-between  block md:hidden">
        ...
        <a href="{{ route('index.produk') }}" href="javascript:void(0);"
    ...
    <div class="border bg-lightwhite dark:bg-white/5 dark:border-white/10 border-black/10 rounded-md">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center p-5 gap-4">
            ...
            <form id="filterForm" action="{{ route('produk.log.detail') }}" method="GET"
                class="flex flex-row items-center justify-center gap-2 section2">
                @csrf

                <select name="produk_id"
                    class="select form-select w-full py-2 px-3 text-sm border border-gray-300 dark:bg-blackrounded-md dark:bg-black bg-white dark:border-white/10 text-gray-900 dark:text-gray-100"
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div id="filterTahunan"
                                            ...
                                            <select name="tahun_tahun"
                                                ...
                                                <option value="">Pilih Tahun</option>
                                                @for($y = date('Y') - 5; $y <= date('Y'); $y++)
                                                    <option value="{{ $y }}" {{ request('tahun_tahun') == $y ? 'selected' : '' }}>
                                                        {{ $y }}</option>
                                                @endfor
                                            </select>
                                        </div>
