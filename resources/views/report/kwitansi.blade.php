    ...
    <div>
        <table>
            <tr>
                ...
                <td class="text-right">
                    <div style="width:320px; margin-left:auto; text-align:center;">
                        <h1 style="margin: 0 0 5px 0;">#NOTA PEMBAYARAN </h1>
            ...
            <tbody>
                ...
                @foreach ($transaksi->ProdukTransaksi as $index => $item)
                    @php
                        ...
                        $total = ($item->barang_terjual ?? 0) * $unitHarga;
                        $grandTotal += $total;
                    @endphp
                    <tr>
                        <td class="text-center">{{ $index+1 }}</td>
                        <td>{{ $item->produk->nama_produk }}</td>
                        <td class="text-center">{{ $item->barang_terjual }}</td>
                ...
                <tr>
                    <td colspan="7"></td>
                    <td class="text-right">Ongkos Kirim (Rp)</td>
       ...
       <table style="margin-top:40px; width:100%; border-collapse: collapse;">
        <tr>
            ...
            <td style="width:70%; vertical-align:top; padding-right:15px;">
                <p style="font-size:11px; line-height:1.4; margin:0 0 6px 0;">
                    {{ $nota->keterangan ?? $perusahaan->keterangan_pembayaran ?? 'Pembayaran dilakukan melalui transfer ke no. Rekeneing xxxxxxx atas nama xxxx setelah diterima informasi penjualan.' }}
                </p>

                <p style="font-size:11px; font-weight:bold; margin:10px 0 4px 0;">Catatan</p>
                <div style="border:1px solid #000; padding:6px; font-size:11px; min-height:60px;">
                    {{ $nota->notes ?? '' }}
                </div>
            </td>
           ...
           <td style="width:30%; text-align:center; vertical-align:top;">
                <p style="font-size:11px; font-weight:bold; margin-bottom:90px;">Hormat Kami</p>


                <!-- Garis tanda tangan -->
                <div style="border-top:1px solid #000; width:150px; margin:0 auto 4px auto;"></div>
                <p style="font-size:11px; margin:0;">
                    {{ auth()->user()->perusahaanUser->nama_perusahaan }}
                </p>
            </td>
