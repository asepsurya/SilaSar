...
<head>
    ...
    <style>
        ...
        p { text-align: center; font-size: 11px; margin-bottom: 15px; }
        ...
        .total-table td { border: none; padding: 4px 6px; }
        .grand-total { border-top: 2px solid #000; font-weight: bold; font-size: 13px; }
        hr { border: none; border-top: 1px dotted #555; margin: 10px 0; }
    </style>
</head>
<body>
    <h2>Laporan Penjualan Detail {{ $id_kota ? '- ' . $id_kota : '' }}</h2>
    <p>
        Periode:
